...
<body>
    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="form">
        ...
        <div class="boxname">
            <input type="text" id="name" name="name" class="form-control btn btn-sm" placeholder="Name"
                style="text-transform:unset !important; width: 310px; text-align: center;">
        </div>
        ...
        <div class="boxprice">
            <input type="text" id="price" name="price" class="form-control btn btn-sm" placeholder="Price"
                style="text-transform:unset !important; width: 150px; text-align: center;">
        </div>

        <div class="baris4-2">Qty</div>
        <div class="boxqty">
            <input type="number" id="qty" name="qty" class="form-control btn btn-sm" placeholder="Qty"
